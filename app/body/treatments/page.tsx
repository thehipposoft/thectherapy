...
const BODY_DATA = {
    ...
    sections: [
        ...
        },
        {
            ...
            title: 'Massages',
            paragraphs: <div className='flex flex-col gap-4'>
                <p>Enjoy the relaxing oil massage with acupressure and relaxing music and aromatherapy for the time that you need. Or choose the customize massage and we can focus on your needs and add other therapeutic technics.</p>
            </div>,
            href: 'https://www.fresha.com/book-now/the-c-therapy-macid731/services?lid=507601&eid=1482022&oiid=sv%3A7486315&share=true&pId=474146'
...
/*         {
        ...
        }, */
        {
            ...
            title: 'Body sculpting: Radiofrequency | Fat cavitation',
            paragraphs: 
                <div className='flex flex-col gap-4'>
                    ...
                    <p>• Fat cavitation. Also known as non-surgical liposuction, consists of a painless reducing treatment with immediate effects whose objective is to eliminate the fat deposits present in the body from the abdomen, flanks, lower back, buttocks, trochanters and thighs,without the need to carry out a surgical procedure.</p>
                    <p>Recommended 10 to 12 sessions for better results.<br /> Frecuency 1 to 2 per week mínimum.</p>
                </div>
                ,
            href: 'https://www.fresha.com/book-now/the-c-therapy-macid731/services?lid=507601&eid=1482022&oiid=sv%3A10318982&share=true&pId=474146',
        },
    ],
}
