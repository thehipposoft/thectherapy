...
const BODY_DATA = {
    ...
    sections: [
        ...
        },
        {
            ...
            paragraphs: <div className='flex flex-col gap-4'>
                <p>Immerse yourself in the ultimate rejuvenation with our Crystal Relaxation treatment. This indulgent experience begins with a 45-minute relaxing oil body massage and is followed by a 45-minute facial, providing a complete spa escape.</p>
