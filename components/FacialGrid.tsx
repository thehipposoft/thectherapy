        ...
        <div className='grid md:grid-cols-2 grid-cols-1 md:grid-rows-2'>
            ...
            <div className=' md:h-[600px] h-[500px] relative flex justify-center items-center group'>
                ...
                <div className='flex flex-col gap-6 relative z-10 md:w-[450px] w-[75vw] mx-auto md:mx-0'>
                    ...
                    <Link href={'/facial/skin-hydration'} className='flex justify-between items-center gap-20 border border-[#FFFFFF] duration-300 group-hover:text-nav group-hover:border-nav w-fit px-5 py-4 '>
                        <p className='text-[#FFFFFF] duration-300 group-hover:text-nav'>Discover</p>
                        <svg className='w-6 h-6 stroke-[#FFFFFF] group-hover:stroke-nav duration-300' fill='none' xmlns="http://www.w3.org/2000/svg"><g className=''><path d="M3.75 12h16.5M13.5 5.25 20.25 12l-6.75 6.75"/></g></svg>
                    </Link>
                </div>
            ...
            <div className='md:h-[600px] h-[500px] relative flex justify-center items-center group'>
                ...
                <div className='flex flex-col gap-6 relative z-10 md:w-[450px] w-[75vw] mx-auto md:mx-0'>
                    ...
                    <Link href={'/facial/skin-renewal'} className='flex justify-between items-center gap-20 border border-[#FFFFFF] duration-300 group-hover:text-nav group-hover:border-nav w-fit px-5 py-4 '>
                        <p className='text-[#FFFFFF] duration-300 group-hover:text-nav'>Discover</p>
                        <svg className='w-6 h-6 stroke-[#FFFFFF] group-hover:stroke-nav duration-300' fill='none' xmlns="http://www.w3.org/2000/svg"><g className=''><path d="M3.75 12h16.5M13.5 5.25 20.25 12l-6.75 6.75"/></g></svg>
                    </Link>
                </div>
            ...
            <div className='md:h-[600px] h-[500px] relative flex justify-center items-center group'>
                ...
                <div className='flex flex-col gap-6 relative z-10 md:w-[450px] w-[75vw] mx-auto md:mx-0'>
                    ...
                    <Link href={'/facial/skin-ageless'} className='flex justify-between items-center gap-20 border border-[#FFFFFF] duration-300 group-hover:text-nav group-hover:border-nav w-fit px-5 py-4 '>
                        <p className='text-[#FFFFFF] duration-300 group-hover:text-nav'>Discover</p>
                        <svg className='w-6 h-6 stroke-[#FFFFFF] group-hover:stroke-nav duration-300' fill='none' xmlns="http://www.w3.org/2000/svg"><g className=''><path d="M3.75 12h16.5M13.5 5.25 20.25 12l-6.75 6.75"/></g></svg>
                    </Link>
                </div>
