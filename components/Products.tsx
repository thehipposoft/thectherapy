    ...
    return (
        <div className='md:pt-24 pb-32'>
            <div className='md:w-[1300px] mx-auto flex flex-col gap-20'>
                <div className='info flex flex-col gap-4 w-[75vw] mx-auto md:mx-0 md:w-auto'>
                ...
                <div className='flex md:justify-end justify-center'>
                    <Link rel='noreferrer' target='_blank' className='py-4 px-24 text-[#FFFFFF] bg-nav' href={'https://www.fresha.com/es/store/the-c-therapy-store-yhbo595r'}>
