    ...
    return (
        <div className='lg:hidden fixed z-40 right-0 top-0'>
            ...
            <ul className={`${isToggle ? 'translate-x-0' : 'translate-x-full'} top-0 right-0 w-screen h-screen absolute overflow-hidden p-8 flex flex-col justify-center items-center gap-10 md:gap-14 bg-[#ffffffe8] duration-700`}>
                ...
                <Link href={'/about'} className='border-b sm:p-2 text-xl' onMouseUp={toggleMenu}>
                    About
                </Link>
                <Link href={'/facial'} className='border-b sm:p-2 text-xl' onMouseUp={toggleMenu}>
                    Facials
                </Link>
                <Link href={'/skin-consultation'} className='border-b sm:p-2 text-xl' onMouseUp={toggleMenu}>
                    Skin Consultation
                </Link>
                <Link href={'/body/treatments'} className='border-b sm:p-2 text-xl' onMouseUp={toggleMenu}>
                    Body Treaments
                </Link>
                <Link href={'/body/relax'} className='border-b sm:p-2 text-xl' onMouseUp={toggleMenu}>
                    Skin & Body Relax
                </Link>
