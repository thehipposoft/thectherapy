...
const MobileMenu = () => {
    ...
    return (
        <div className='md:hidden fixed z-40 right-3 top-3'>
            <div
                onClick={toggleMenu} 
                className='relative sm:w-[8vw] w-[12vw] border border-[#87807040] rounded-md right-3 top-3 z-40 bg-[#fffffff7] flex flex-col items-center gap-[5px] py-4'
            >
            ...
            <ul className={`${isToggle ? 'w-[90vw] h-[95vh] top-0 right-0' : 'w-0 h-0 -top-[200%] right-[50%]'} absolute overflow-hidden p-8 flex flex-col justify-center items-center gap-10 bg-[#ffffffe8] duration-700`}>
                ...
                <Link href={'https://store.thectherapy.com.au/'} target='_blank' className='border-b p-2 text-2xl' onMouseUp={toggleMenu}>
                    STORE
                </Link>
