...
const Header = () => {
    return (
        <div className='md:flex items-center justify-between md:w-[1300px] hidden mx-auto bg-[#FBFEFB] '>
            <Nav />
            ...
            <div className='flex justify-between items-center gap-6'>
                ...
                <Link href={'https://www.fresha.com/es/a/the-c-therapy-melbourne-k3-high-street-b0pgn0xk/all-offer?menu=true'} className='bg-[#CDCBC0] border-[#CDCBC0] border  px-5 py-3 duration-500 hover:bg-[#FFFFFF] hover:text-nav hover:border-nav'>
                    BOOK NOW
                </Link>
            </div>
        </div>
