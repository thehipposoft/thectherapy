        ...
        <div  className='w-screen md:flex hidden bg-[#FBFEFB] py-1'>
            <div className='lg:w-[90vw] md:flex mx-auto gap-6 items-center justify-between'>
                ...
                <div className='flex justify-between items-center gap-6'>
                    ...
                    <Link href={'https://www.fresha.com/es/a/the-c-therapy-melbourne-k3-high-street-b0pgn0xk/all-offer?menu=true'} target='_blank' className='bg-[#CDCBC0] border-[#CDCBC0] border  md:text-sm lg:text-base md:px-2 lg:px-5 py-3 duration-500 hover:bg-[#FFFFFF] hover:text-nav hover:border-nav'>
                        BOOK NOW
                    </Link>
                </div>
            </div>
