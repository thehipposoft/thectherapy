...
const Treatments = () => {
    ...
    return (
        <div className='h-[575px] relative flex items-center' ref={container}>
            ...
            <div className='flex flex-col gap-6 relative z-10 md:pl-28 content w-[75vw] md:w-auto mx-auto md:mx-0' >
                ...
                <Link href={'/body'} className='flex justify-between items-center gap-6 border border-[#FFFFFF] w-fit px-5 py-4 '>
                    <p className='text-[#FFFFFF] text-sm'>Our body treatments</p>
