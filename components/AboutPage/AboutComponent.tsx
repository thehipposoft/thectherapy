...
const AboutComponent = () => {
    ...
    return (
        <div ref={container} className='pb-20 flex flex-col md:gap-32 lg:gap-12 md:mt-20 lg:mt-0'>
            <div 
                ref={trigger}
                className='lg:h-screen md:flex items-center md:bg-right bg-top relative'
            >
                <Image src={'/assets/images/about/background-2.webp'} alt='' fill  className='object-contain md:object-right lg:object-contain lg:object-right object-top'/>
                <div  className='flex md:flex-row-reverse flex-col justify-between md:w-[85vw] 2xl:w-[70vw] 2xl:mx-auto 2xl:pl-0 lg:pl-28 pt-40 md:pt-0 gap-12 w-[75vw] mx-auto lg:mx-0'>
                        <Image 
                            width={1600}
                            height={1067} 
                            alt='Carolina picture' 
                            src={'/assets/images/about/about-3.webp'} 
                            className='object-cover image h-[400px] md:h-[500px] w-[80vw] md:w-[450px] lg:w-[525px] 2xl:h-[650px] 2xl:w-[650px] relative z-10'
                        />
                    <div className='flex flex-col justify-center gap-6 '>
                        <div className='flex flex-col gap-6 md:bg-[#FFFFFF33]'>
            ...
            >
                ...
                <div className='flex md:flex-row-reverse flex-col justify-between md:w-[85vw] lg:pl-28 2xl:pl-0 2xl:w-[70vw] 2xl:mx-auto pt-40 md:pt-0 gap-12 w-[75vw] mx-auto lg:mx-0'>
                        <Image 
                            width={1800} 
                            height={1200} 
                            alt='Carolina picture' 
                            src={'/assets/images/about/about-4.webp'} 
                            className='object-cover imageTwo h-[400px] md:h-[500px] w-[80vw] md:w-[450px] lg:w-[525px] 2xl:h-[650px] 2xl:w-[650px] relative z-10'
                        />
                    <div className='flex flex-col justify-center gap-6'>
