...
const BodyMindSoul = () => {
    ...
    return (
        <div ref={container} className='lg:h-[560px] relative flex items-center justify-center pb-20'>
            <Image src={'/assets/images/about/bodymindsoul.webp'} fill alt='Texture Background'  />
            <div className='lg:w-[1250px] relative z-10 flex flex-col lg:flex-row items-center md:gap-12 gap-8'>
                ...
                <div className='lg:w-[1px] w-[350px] lg:h-[350px] h-[1px] bg-[#6E6460]' />
                ...
                <div className='md:w-full flex lg:justify-center w-[75vw] mx-auto md:mx-0'>
