        ...
        <div className='h-[95vh] relative'>
            ...
            <div className='max-w-[1300px] w-[75vw] md:w-auto mx-auto relative z-10 flex h-full items-center'>
                <div className='flex flex-col justify-center gap-6 md:w-[395px]'>
                    ...
                    <Link href={'/facial'} className='group flex justify-between items-center gap-6 border border-[#FFFFFF] hover:border-[#000000] duration-500 w-fit px-5 py-4 bg-[#ffffff0e]'>
                        <p className='text-[#FFFFFF] group-hover:text-[#000000] duration-500 text-sm'>Discover More</p>
                        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#fff" className='group-hover:stroke-[#000000] duration-500' ><path d="M3.75 12h16.5M13.5 5.25 20.25 12l-6.75 6.75"/></g></svg>
                    </Link>
                </div>
            </div>
        </div>
